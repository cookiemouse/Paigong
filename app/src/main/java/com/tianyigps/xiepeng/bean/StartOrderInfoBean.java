...
public class StartOrderInfoBean {
    ...
    public static class ObjBean {
         ...
         * signature : data:image/png;base64,/9j/ACgAoAKACgAoAKACgAoAKACgAoAKACgAoA//Z
         * status : 3
         * submitAddress :
