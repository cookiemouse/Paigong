...
public class UploadTest {
    ...
    public static class CarInfoBean {
        ...
        public CarInfoBean(int carId, String carNo, String carVin, String carBrand, List<TerminalInfoBean> terminalInfo) {
            this.carId = carId;
            this.carNo = carNo;
            this.carVin = carVin;
        ...
        public static class TerminalInfoBean {
            ...
            public TerminalInfoBean(int tid, String oldImei, String newImei, int modle, int locateType, String newInstallPosition) {
                this.tid = tid;
