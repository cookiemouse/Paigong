...
//    private static final String IP = "http://dser.tianyigps.cn:8081/dispatch-services";
    ...
    public static final String URL_WORKER_UPLOAD_PIC = IP + "/dispatch4AppController/uploadPic4EngineerOss";
    public static final String URL_WORKER_DELETE_PIC = IP + "/dispatch4AppController/deletePic4EngineerOss?";
...
//    public static final String URL_MANAGER_PENDED_DETAILS_FOR_PUSH = IP + "/dispatch4AppController/getOrderInfoByOrderNoForPush?";
    public static final String URL_MANAGER_PENDED_DETAILS_FOR_PUSH = IP + "/dispatch4AppController/getOrderInfoByOrderIdForPush?";
